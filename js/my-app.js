...
var emailscomplete = ('gmail.com hotmail.com hotmail.es yahoo.es Melonesprueba1prueba9087 Orange Peach Pear Pineapple').split(' ');
...
function registry3(){
        var clienteres = { 
         ...
         correo : $('#mail1').val(), 
         sexo : $('input[name=drone]:checked', '.label-content2').val(),
         telefono : $('#phone1').val(),
         municipio : $('#city1').val(),
         fecha : $('#birthday1').val()
     };
