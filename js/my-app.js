						...
						var resultscategory = obj.boxerCategoria;
							...
							var popupHTML = '<div class="popup">'+
						                    ...
						                    '<a id="close" href="index.html" class="close-popup"><div class="navbar_right2"><img class="Navbar-img" src="images/icons/black/back.png" alt="" title=""></div></a>'+						                     
						                      ...
						                      '<div class="row"><div class="col-50 content-img"><div class="box"><h2 class="page_title_secondary2">Imagen de Referencia</h2><img class="imgguia" src="http://35.231.135.74/boxerCategoria/verImagenes/'+resultscategory.identificadorImagen+'"></div></div><div class="col-50 section-sus"><h2 class="page_title2">Si deseas suscríbirte a esta Categoría</h2><h2 class="page_title_secondary2">Por favor ingrese su número de documento</h2><div class=""><div class="list-block"><ul><div class="row"><div class="col-80"><li class = "item-content"><div class = "item-inner"><div class = "item-input"><input id="documentsearchguiaa" onchange="documentsearchGuia();" type="number" style="font-size: 18px !important;" class="input-form" required name="document" placeholder="Número de documento"></div></div></li></div></div></ul></div><div class = "list-block"><ul><button onclick="suscribirmeGuia();"  class="item-link list-button" style="font-size: 14px;" type="button">SUSCRIBIRME</button></ul></div></div></div></div>'+
						                      ''+
						                    '</div>'+
						                  '</div>'
						  myApp.popup(popupHTML);
