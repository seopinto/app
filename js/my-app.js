...
function registryCalification(){
        var clienteres = { 
         ...
         municipio : $('#city1').val(),
         fecha : $('#birthday1').val(),
         tiendaFavorita : document.getElementById("tiendaf1").value
     };
...
function RegistryUserBlog(){
        var clienteRegisBlog = { 
         ...
         tiendaFavorita : document.getElementById("tiendaf_blog").value
     };
...
function RegistryUserGuia(){
        var clienteRegisBlog = { 
         ...
         tiendaFavorita : document.getElementById("tiendaf_guia").value
     };
...
function registryPQRS(){
        var cliente = { 
         ...
         tiendaFavorita : document.getElementById("tiendaf_reg").value
     };
...
myApp.onPageInit('registro2', function (page){
    ...
    $$('#registry').click(function(){	   
         ...
         fecha : $('#birthday').val(),
         municipio : $('#city').val(),
         tiendaFavorita : document.getElementById("tiendaf").value
     };
       $.ajax({
            url : 'http://35.231.135.74:80/clientes',
            processData: false,
